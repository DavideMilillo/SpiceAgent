...
# RC_circuit.asc is in ../PyLTSpice/ relative to this script
circuit_path = os.path.join(current_dir, '..', 'PyLTSpice', 'RC_circuit.asc')
output_folder = os.path.join(current_dir, 'sim_output')
...
Explain the results and evaluate the time constant of the circuit.
"""
